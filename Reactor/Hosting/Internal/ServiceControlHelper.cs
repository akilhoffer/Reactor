...
namespace Reactor.Hosting.Internal
{
    ...
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof (ServiceControlHelper));
        ...
        public static bool IsServiceInstalled(string serviceName)
        {
            ...
            Log.DebugFormat("Checking if service '{0}' is already installed...", serviceName);

            bool returnValue = GetInstalledServices().Contains(serviceName);
            Log.DebugFormat("Service '{0}' is {1} installed.", serviceName, returnValue ? "already" : "not yet");
            return returnValue;
        }
        ...
        public static void AllowServiceToInteractWithDesktop(string serviceName)
        {
            ...
            Log.DebugFormat("Allowing service '{0}' to interact with desktop...", serviceName);
            ...
            Log.DebugFormat("Done allowing service '{0}' to interact with desktop.", serviceName);
        }

        public static List<string> GetInstalledServices()
        {
            return GetInstalledServices(s => true);
        }

        public static List<string> GetInstalledServices(Predicate<ServiceController> filter)
        {
            Log.Debug("Getting list of installed services...");
            ...
            var returnValue = new List<string>(
                Array.ConvertAll(
                    ...
                    s => s.ServiceName));
            Log.DebugFormat("Done getting list of installed services. Found '{0}' services.", returnValue.Count);
        ...
        {
            Log.Debug("Granting shutdown privileges to process user...");
            ...
            finally
            {
                ...
                Log.Debug("Done granting shutdown privileges to process user.");
            }
        }
    }
}
